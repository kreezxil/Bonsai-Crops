...
import com.kreezcraft.bonsaicrops.api.BonsaiDropChances;
...
public class ConfigurationHandler {
    ...
    private static void loadConfiguration() {
        ...
        IntegrationSettings.disabledIntegrations = configuration.getStringList(
                "disabledIntegrations", CATEGORY_INTEGRATION, new String[] {}, "Integrations to disable (by classname, e.g. com.kreezcraft.bonsaicrops.integration.mods.PamsHarvestcraft)"
        );
