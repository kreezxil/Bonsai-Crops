...
public class BaseTrigger implements ICriterionTrigger<BaseTrigger.Instance> {
    ...
    private final Map<PlayerAdvancements, BaseTrigger.Listeners> listeners = Maps.<PlayerAdvancements, BaseTrigger.Listeners>newHashMap();
    ...
    static class Listeners {
        ...
        private final Set<ICriterionTrigger.Listener<BaseTrigger.Instance>> listeners = Sets.<ICriterionTrigger.Listener<BaseTrigger.Instance>>newHashSet();
        ...
        public void trigger(EntityPlayerMP player) {
            List<ICriterionTrigger.Listener<BaseTrigger.Instance>> list = null;
